...
\begin{enumerate}[1.]
    ...
    \item
        ...
        If $\neg$$c$, then $\neg$($a$ or $b$) and: \\
            ...
            $\neg$$a$ and $b$ is not possible. \\
            $\neg$$a$ and $\neg$$b$ when today is Monday. \\
        \\
        So, the only possible days are Monday, Tuesday, or Wednesday.
    \item 
        $a$ = Yesterday was a lying day for Lion. \\
        ...
        \\
        If $\neg$$c$, then $\neg$($a$ or $b$) and: \\
        $a$ and $\neg$$b$ when is not possible. \\
        $\neg$$a$ and $b$ when today is Monday. \\
        $\neg$$a$ and $\neg$$b$ is not possible. \\
        \\
        So the possible days are Monday or Wednesday.
        \pagebreak
    \item
